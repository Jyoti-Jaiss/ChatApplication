...
public class UserOne implements ActionListener, Runnable {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        text.setText("");
        try {
            JLabel label2 = new JLabel("<html><center>New message</center></html>");

            vertical.add(label2);


            String out = "<html><p><b>" + name + "</b></p><p>" + message + "</p></html>";
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/chat_app", "root", "12345678");
